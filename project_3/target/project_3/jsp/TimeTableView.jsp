					...
					<div class="card">
						<div class="card-body">
							<%
								...
								if (id > 0) {
							%>
							<h3 class="text-center text-primary">Update TimeTable</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-primary">Add TimeTable</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<br> <span class="pl-sm-5"><b>Subject</b><span
								...
								<br> <span class="pl-sm-5"><b>Semester</b><span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<%
											...
											map.put("1semester", "1 semester");
											map.put("2semester", "2 semester");
											map.put("3semester", "3 semester");
											map.put("4semester", "4 semester");
											map.put("5semester", "5 semester");
											map.put("6semester", "6 semester");
											map.put("7semester", "7 semester");
											map.put("8semester", "8 semester");
											map.put("9semester", "9 semester");
											map.put("10semester", "10 semester");
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("semesterId", request)%></font>
								<br> <span class="pl-sm-5"><b>Exam Date</b><span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="examDate"
											placeholder="Enter Exam Date" id="datepicker"
											readonly="readonly"
								...
								<br> <span class="pl-sm-5"><b>Exam Time</b><span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("examId", request)%></font>

								<br> <span class="pl-sm-5"><b>Description</b><span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<textarea class="form-control" name="description"
											placeholder="Enter Description" rows="5" cols="5">
