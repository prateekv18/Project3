...
public class TimetableModelJDBCImpl implements TimetableModelInt {
	...
	public long add(TimetableDTO tdto) throws ApplicationException {
		...
		/*
		 * // get course Name and Subject Name by id CourseModelInt model1 =
		 * ModelFactory.getInstance().getCourseModel();
		 * 
		 * CourseDTO cdto = null; cdto = model1.findByPK(tdto.getCourseId());
	 ...
	 * 
	 * @param tdto
	 *            an object of TimetableDTO class
	 ...
	 * 
	 * @param tdto
	 *            an object of class TimetableDTO
	 * @throws ApplicationException
	 *             an application exception
