					...
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("courseName", request)%>
								</font> <br> <span class="pl-sm-5"><b>Duration</b><span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%
											...
											map.put("1Year", "1 Year");
											map.put("2Year", "2 Year");
											map.put("3Year", "3 Year");
											map.put("4Year", "4 Year");
											map.put("5Year", "5 Year");
											String HtmlList = HTMLUtility.getList("duration", dto.getDuration(), map);
										%>
										<%=HtmlList%></div>

								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("duration", request)%></font>
