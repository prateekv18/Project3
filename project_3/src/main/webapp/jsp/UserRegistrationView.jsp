...
<style type="text/css">
.hm-gradient {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/work.jpg');
	background-size: 120%;
	.
	log1
	{
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<br> <span class="pl-sm-5"><b>Last Name</b> <span
								style="color: red;">*</span></span>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
							...
							<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("password", request)%></font>
							<br> <span class="pl-sm-5"><b>Confirm Password</b> <span
								style="color: red;">*</span></span>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
