		...
		<form class="pb-5" action="<%=ORSView.USER_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="text-primary font-weight-bold pt-3">
					<font color="#162390">User List</font>
				</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("Role", String.valueOf(dto.getRoleId()), list1)%>
				</div>
				...
				<table class="table" bgcolor="white">
					...
					<%
						while (it.hasNext()) {
								...
								System.out.println(rbean.getName() + "___________++++++++++++");
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="UserCtl?id=<%=dto.getId()%>"
								<%if (dto.getRoleId() == RoleDTO.ADMIN) {%> <%}%>>Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			%>
			<!-- <center>
				<h1 text-primary font-weight-bold pt-3>User
					List</h1>
