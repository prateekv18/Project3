			...
			<div class="row log1">
				...
				<div class="col-md-4 mb-4">
					...
					: DataUtility.getString(request.getParameter("oldpassword")))%>>
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("oldpassword", request)%>
								</font></br> <span class="pl-sm-5"><b>New Password</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
					...
					: DataUtility.getString(request.getParameter("newpassword")))%>>
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("newpassword", request)%>
								</font> <br> <span class="pl-sm-5"><b>Confirm Password</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
