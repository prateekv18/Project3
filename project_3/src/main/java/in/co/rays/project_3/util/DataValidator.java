...
public class DataValidator {
	 ...
	 * 
	 * boolean pass = false; if (isDate(val)) { Date cdate = new Date(); try {
	 * Date userdate = DataUtility.formatter.parse(val); int age =
	 * cdate.getYear()-userdate.getYear();
	 * System.out.println("final age  "+age); if(age>=18){ pass=true; } } catch
	 * (ParseException e) {
	 * 
	 * } }
	 * 
