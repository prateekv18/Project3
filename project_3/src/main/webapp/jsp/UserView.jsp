					...
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								...
								</font> <br> <span class="pl-sm-5"><b>Last Name</b> <span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								</font> <br> <span class="pl-sm-5"><b>Confirm Password</b>
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%>
								</font>
								<%
									}
								%>
								<br> <span class="pl-sm-5"><b>Email Id</b> <span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<br> <span class="pl-sm-5"><b>Mobile No</b> <span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<br> <span class="pl-sm-5"><b>Role</b><span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("role", request)%></font>

								<br> <span class="pl-sm-5"><b>Gender</b><span
									style="color: red;">*</span></span>
								...
								<br> <span class="pl-sm-5"><b>DOB</b> <span
									style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
