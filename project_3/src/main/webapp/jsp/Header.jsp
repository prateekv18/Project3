...
<body>
	...
	%>
	<div class="header">
		<nav class="navbar navbar-expand-lg navbar-dark bg-secondary"> <a
			class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>"><img
			src="<%=ORSView.APP_CONTEXT%>/img/custom.png" width="100px"
			height="50px"></a>
				...
				<li class="nav-item dropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>"><i
							class="fas fa-sign-in-alt">Login</i></a> <a class="dropdown-item"
